...
function M.create_commands()
  ...
  vim.cmd("command! -nargs=? TestBuffer :lua require('glow').create_markdown_window('<f-args>')")
...
function M.create_markdown_window(file)
  ...
  -- Set buffer to newly created window
  vim.api.nvim_win_set_buf(win, buf)
  -- Execute glow command inside new terminal
  vim.fn.termopen(string.format("glow %s", vim.fn.shellescape('test.md')))
